...
heading1=Label(root,text="KR HOTEL",font="arial 30 bold",fg="#fc5a03")
heading2=Label(root,text="@Fire_tamizhan-Restaurent ",font="arial 18 bold",fg="#fc5a03")
